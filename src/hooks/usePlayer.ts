  ...
  useEffect(() => {
    ...
    const updateState = () => {
      setPlayerState({
        ...
        isPiPActive: Boolean(document.pictureInPictureElement)
      });
    };
    ...
    player.on('enterpictureinpicture', updateState);
    player.on('leavepictureinpicture', updateState);
    ...
    return () => {
      ...
      player.off('enterpictureinpicture', updateState);
      player.off('leavepictureinpicture', updateState);
    };
  }, [player]);
